"""Regression checks for the signal-sec-policy-vault casebook."""
...
from casebook.harness import assert_expected, signal_sec_policy_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_sec_policy_vault_summary(), assert_expected())
